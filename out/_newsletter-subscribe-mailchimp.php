<?php
/*
 * Petrichor v1.0 - MailChimp newsletter subscription script
 * (c) Web factory Ltd
 * www.webfactoryltd.com
**/

  // your MailChimp API Key
  define('MAILCHIMP_API_KEY', '6b8b3e28ae64ad8b875404d0902afa93-us6');
  // list ID to which people are subscribing
  define('MAILCHIMP_LIST_NAME', 'Contatos Site People Interactive');
